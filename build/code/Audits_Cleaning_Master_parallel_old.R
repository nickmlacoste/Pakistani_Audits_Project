...
"
This script calls the grf_pre_cleaning.R script in batches, with parallel processing
"
...
process_file <- function(file) {
  ...
  # Return the path of the Parquet file for final merging
  return(output_parquet)
}

# Process all batch files in parallel and collect the paths of Parquet files
parquet_files <- future_map_chr(batch_files, process_file)
